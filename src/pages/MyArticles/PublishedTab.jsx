...
import { FileText, Clock, Eye, Edit3, Trash2, ExternalLink, Inbox, CheckCircle2 } from 'lucide-react';
  ...
  if (!articles || articles.length === 0) return (
    <div className="bg-white p-20 rounded-[3rem] border border-gray-50 text-center space-y-6 animate-in zoom-in duration-500">
      ...
      <div className="space-y-2">
        <h3 className="text-2xl font-serif font-bold text-primary tracking-tight">No Published Articles</h3>
        <p className="text-gray-400 font-medium max-w-sm mx-auto italic">Your successfully published research will appear here for global dissemination and impact tracking.</p>
      </div>
    </div>
  );
