...
import { FileText, Clock, Eye, ExternalLink, ShieldAlert, Inbox, UserPlus } from 'lucide-react';
import { Link } from 'react-router-dom';

const ArticleRow = ({ article, onWithdraw, onAssignReviewer }) => (
...
const UnderReviewTab = ({ articles, isLoading, onWithdraw, onAssignReviewer }) => {
  ...
  return <div className="space-y-6">{articles.map(article => <ArticleRow key={article.id} article={article} onWithdraw={onWithdraw} onAssignReviewer={onAssignReviewer} />)}</div>;
};
